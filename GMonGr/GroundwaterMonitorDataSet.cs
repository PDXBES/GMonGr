...
{     
    public partial class GroundwaterMonitorDataSet 
    {
      ...
      public void InitTableP5204()
      {
        ...
        p5204TA.Fill(tableP5204);
      }

      public void InitTableTGD01A()
      {
        GroundwaterMonitorDataSetTableAdapters.TGD01ATableAdapter tGD01ATA;
        tGD01ATA = new GMonGr.GroundwaterMonitorDataSetTableAdapters.TGD01ATableAdapter();
        tGD01ATA.Fill(tableTGD01A);
      }

      public void InitTableTGD01B()
      {
        GroundwaterMonitorDataSetTableAdapters.TGD01BTableAdapter tGD01BTA;
        tGD01BTA = new GMonGr.GroundwaterMonitorDataSetTableAdapters.TGD01BTableAdapter();
        tGD01BTA.Fill(tableTGD01B);
      }

      public void InitTableTGD02A()
      {
        GroundwaterMonitorDataSetTableAdapters.TGD02ATableAdapter tGD02ATA;
        tGD02ATA = new GMonGr.GroundwaterMonitorDataSetTableAdapters.TGD02ATableAdapter();
        tGD02ATA.Fill(tableTGD02A);
      }

      public void InitTableTGD02B()
      {
        GroundwaterMonitorDataSetTableAdapters.TGD02BTableAdapter tGD02BTA;
        tGD02BTA = new GMonGr.GroundwaterMonitorDataSetTableAdapters.TGD02BTableAdapter();
        tGD02BTA.Fill(tableTGD02B);
      }

      public void InitTableTGD03A()
      {
        GroundwaterMonitorDataSetTableAdapters.TGD03ATableAdapter tGD03ATA;
        tGD03ATA = new GMonGr.GroundwaterMonitorDataSetTableAdapters.TGD03ATableAdapter();
        tGD03ATA.Fill(tableTGD03A);
      }

      public void InitTableTGD03B()
      {
        GroundwaterMonitorDataSetTableAdapters.TGD03BTableAdapter tGD03BTA;
