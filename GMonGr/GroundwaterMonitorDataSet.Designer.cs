...
namespace GMonGr {
    ...
    public partial class GroundwaterMonitorDataSet : global::System.Data.DataSet {
        ...
        public partial class SESSIONDataTable : global::System.Data.TypedTableBase<SESSIONRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public SESSIONRow AddSESSIONRow(System.DateTime edit_date, string edited_by, string sensor_name, string update_comment, System.DateTime reading_start_date, System.DateTime reading_end_date) {
            ...
            private void InitClass() {
                ...
                this.Constraints.Add(new global::System.Data.UniqueConstraint("Constraint1", new global::System.Data.DataColumn[] {
                                this.columnsession_edit_id}, true));
                this.columnsession_edit_id.AutoIncrement = true;
                this.columnsession_edit_id.AutoIncrementSeed = -1;
                this.columnsession_edit_id.AutoIncrementStep = -1;
                this.columnsession_edit_id.AllowDBNull = false;
                this.columnsession_edit_id.ReadOnly = true;
                this.columnsession_edit_id.Unique = true;
                this.columnedit_date.AllowDBNull = false;
                this.columnedited_by.AllowDBNull = false;
                this.columnedited_by.MaxLength = 50;
...
SELECT gwmon_edit_id, session_edit_id, edit_date, edited_by, sensor_name, reading_date, reading_hertz, head_psi, head_ft, temp_celsius, f2_scale, gw_depth_ft, gw_elev_ft, data_qual_flag FROM GW_MONITOR_READING WHERE (gwmon_edit_id = SCOPE_IDENTITY())";
    ...
    public partial class SESSIONTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [SESSION] ([edit_date], [edited_by], [sensor_name], [update_comment], [reading_start_date], [reading_end_date]) VALUES (@edit_date, @edited_by, @sensor_name, @update_comment, @reading_start_date, @reading_end_date);
SELECT session_edit_id, edit_date, edited_by, sensor_name, update_comment, reading_start_date, reading_end_date FROM SESSION WHERE (session_edit_id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@edit_date", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "edit_date", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@edited_by", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "edited_by", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@sensor_name", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "sensor_name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [SESSION] SET [edit_date] = @edit_date, [edited_by] = @edited_by, [sensor_name] = @sensor_name, [update_comment] = @update_comment, [reading_start_date] = @reading_start_date, [reading_end_date] = @reading_end_date WHERE (([session_edit_id] = @Original_session_edit_id) AND ([edit_date] = @Original_edit_date) AND ([edited_by] = @Original_edited_by) AND ([sensor_name] = @Original_sensor_name) AND ([update_comment] = @Original_update_comment) AND ([reading_start_date] = @Original_reading_start_date) AND ([reading_end_date] = @Original_reading_end_date));
SELECT session_edit_id, edit_date, edited_by, sensor_name, update_comment, reading_start_date, reading_end_date FROM SESSION WHERE (session_edit_id = @session_edit_id)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_reading_start_date", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "reading_start_date", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_reading_end_date", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "reading_end_date", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@session_edit_id", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "session_edit_id", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(System.DateTime edit_date, string edited_by, string sensor_name, string update_comment, System.DateTime reading_start_date, System.DateTime reading_end_date) {
            ...
            if ((sensor_name == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(sensor_name));
            }
            if ((update_comment == null)) {
                throw new global::System.ArgumentNullException("update_comment");
            }
            else {
                this.Adapter.InsertCommand.Parameters[3].Value = ((string)(update_comment));
            }
            this.Adapter.InsertCommand.Parameters[4].Value = ((System.DateTime)(reading_start_date));
            this.Adapter.InsertCommand.Parameters[5].Value = ((System.DateTime)(reading_end_date));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.InsertCommand.Connection.State;
            if (((this.Adapter.InsertCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.InsertCommand.Connection.Open();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime edit_date, string edited_by, string sensor_name, string update_comment, System.DateTime reading_start_date, System.DateTime reading_end_date, int Original_session_edit_id, System.DateTime Original_edit_date, string Original_edited_by, string Original_sensor_name, string Original_update_comment, System.DateTime Original_reading_start_date, System.DateTime Original_reading_end_date, int session_edit_id) {
            ...
            if ((sensor_name == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(sensor_name));
            }
            if ((update_comment == null)) {
                throw new global::System.ArgumentNullException("update_comment");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((string)(update_comment));
            }
            this.Adapter.UpdateCommand.Parameters[4].Value = ((System.DateTime)(reading_start_date));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((System.DateTime)(reading_end_date));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_session_edit_id));
            this.Adapter.UpdateCommand.Parameters[7].Value = ((System.DateTime)(Original_edit_date));
            if ((Original_edited_by == null)) {
                throw new global::System.ArgumentNullException("Original_edited_by");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[8].Value = ((string)(Original_edited_by));
            }
            if ((Original_sensor_name == null)) {
                throw new global::System.ArgumentNullException("Original_sensor_name");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_sensor_name));
            }
            if ((Original_update_comment == null)) {
                throw new global::System.ArgumentNullException("Original_update_comment");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[10].Value = ((string)(Original_update_comment));
            }
            this.Adapter.UpdateCommand.Parameters[11].Value = ((System.DateTime)(Original_reading_start_date));
            this.Adapter.UpdateCommand.Parameters[12].Value = ((System.DateTime)(Original_reading_end_date));
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(session_edit_id));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime edit_date, string edited_by, string sensor_name, string update_comment, System.DateTime reading_start_date, System.DateTime reading_end_date, int Original_session_edit_id, System.DateTime Original_edit_date, string Original_edited_by, string Original_sensor_name, string Original_update_comment, System.DateTime Original_reading_start_date, System.DateTime Original_reading_end_date) {
            return this.Update(edit_date, edited_by, sensor_name, update_comment, reading_start_date, reading_end_date, Original_session_edit_id, Original_edit_date, Original_edited_by, Original_sensor_name, Original_update_comment, Original_reading_start_date, Original_reading_end_date, Original_session_edit_id);
        }
    }
